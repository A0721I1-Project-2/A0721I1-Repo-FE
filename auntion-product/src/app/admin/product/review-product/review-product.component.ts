...
// tslint:disable-next-line:no-unused-expression
  ...
  approveProduct() {
    ...
    this.productService.updateProduct(this.product).subscribe(() => {
      this.router.navigateByUrl('/admin/product/list').then(r => alert('Approved successfully!'));
    });
  }
  ...
  rejectProduct() {
    ...
    this.productService.updateProduct(this.product).subscribe(() => {
      this.router.navigateByUrl('/admin/product/list').then(r => alert('Feedback sent successfully!'));
    });
  }
}
