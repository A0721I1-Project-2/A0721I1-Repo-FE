...
export class ListProductComponent implements OnInit {
  ...
  idSelectedProduct: any;
  productSelected: any;
  listIdSelectedProduct: any[] = [];
...
// tslint:disable-next-line:no-unused-expression
  ...
  onChangeDelete($event: any) {
    ...
    if (this.productSelected) {
      this.listIdSelectedProduct.push(this.idSelectedProduct);
    } else {
      this.listIdSelectedProduct.splice(this.listIdSelectedProduct.indexOf(this.idSelectedProduct), 1);
    }
  }
